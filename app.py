...
st.set_page_config(page_title="SatsCommander Pro Terminal", layout="wide")
...
st.markdown("""<div class="terminal-shell topbar"><div><div class="brand-title">SatsCommander</div><div class="brand-sub">Pro trading layout · execution engine for stacking sats</div></div><div class="status-pill online">● MARKET DATA LIVE</div></div>""", unsafe_allow_html=True)
...
with left:
    ...
    if queue.empty: st.markdown('<div class="queue-item small">No active execution signals.</div>', unsafe_allow_html=True)
